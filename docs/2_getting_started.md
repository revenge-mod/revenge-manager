# 🚀 Getting started with Revenge Manager
...
To install the Revenge Discord, press the filled **Install** button then you'll 
be taken to the installer page, wait until the installation is finished then 
a prompt to allow special permission will show up, from there follow the 
